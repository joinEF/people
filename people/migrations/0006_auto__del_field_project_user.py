...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'people_project', 'user_id')

        # Adding M2M table for field users on 'Project'
        m2m_table_name = db.shorten_name(u'people_project_users')
    ...
    def backwards(self, orm):
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Project.user'
        db.add_column(u'people_project', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='projects', to=orm['auth.User']),
                      keep_default=False)

        # Removing M2M table for field users on 'Project'
        db.delete_table(db.shorten_name(u'people_project_users'))
