...
class UserProfile(models.Model):
    ...
    description = models.TextField(blank=True, help_text='Parsed as Markdown with inline HTML. See <a href="https://daringfireball.net/projects/markdown/">https://daringfireball.net/projects/markdown/</a>.')
